...
public class Writer {
	...
	public void pars(ArrayList<String> stdControl,ArrayList<String> number,ArrayList<String> control,
		...
		for (int i = 0 ; i < number.size(); i++){
			String [] record = (number.get(i) + "," + stdControl.get(i) + "," + control.get(i) + "," + asset.get(i) +
					"," + org.get(i) + "," + vulnerable.get(i) + "," + security.get(i) + "," + severity.get(i) + "," + threat.get(i) + "," + threatSource.get(i) +
